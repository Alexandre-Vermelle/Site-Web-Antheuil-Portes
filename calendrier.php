...
<!DOCTYPE html>
    <html lang="fr" dir="ltr">
        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: rgb(45, 67, 85)">
            ...
            <section id="titlePresentation">
                <div class="container">
                    <div class= "titleSite col-sm-12 text-center p-4"><h3>CALENDRIER</h3></div>
                </div>
            </section>
<section id="calendar">
